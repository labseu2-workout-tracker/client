...
const exercises = (state = initialState, action) => {
  switch (action.type) {
    case type.FETCH_EXERCISES:
      ...
      const currentExercises = filterOnlyGroupChest.slice(0, 6);
    ...
    case type.LOAD_MORE:
      let indexOfTheLastExercise = state.indexOfLastExercise + 6;
