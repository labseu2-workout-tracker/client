...
import logo from "../assets/image/beFit-logo2.png";
  ...
  return (
    ...
    <aside>
      ...
      <div className="nav-items">
        <SideNavItem icon={icons.search} text={texts.search} path="/myworkouts" />
        <SideNavItem icon={icons.match} text={texts.match} path="/tracker" />
        <SideNavItem icon={icons.match} text={texts.match} path="/history" />
        <SideNavItem
          icon={icons.settings}
          text={texts.settings}
          path="/settings"
